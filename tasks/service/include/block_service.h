...
#ifndef BLOCK_SERVICE_ACTIVITY_LED
#define BLOCK_SERVICE_ACTIVITY_LED 3 // set to -1 to disable
#endif

#if BLOCK_SERVICE_ACTIVITY_LED >= 0
#define BLOCK_SERVICE_ACTIVITY_LED_ON gpio_put(BLOCK_SERVICE_ACTIVITY_LED, true);
#define BLOCK_SERVICE_ACTIVITY_LED_OFF gpio_put(BLOCK_SERVICE_ACTIVITY_LED, false);
#else
#define BLOCK_SERVICE_ACTIVITY_LED_ON
#define BLOCK_SERVICE_ACTIVITY_LED_OFF
#endif
